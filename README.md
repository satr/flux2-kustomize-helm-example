...
## Copy from https://github.com/fluxcd/flux2-kustomize-helm-example
...
spec:
  interval: 1m
  url: https://github.com/satr/podinfo
---
apiVersion: source.toolkit.fluxcd.io/v1beta1
kind: HelmRepository
metadata:
...
Note that with ` interval: 1m` we configure Flux to pull the Helm repository index every five minutes.
